...
So,if you put alphabet in phone field,admin table will get error and the inserted user table data will be rollback.So,it will help you in case of remaining data from broken transaction.
